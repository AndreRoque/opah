...
using Opah.Lancamento.Application.Services;
...
using Opah.Lancamento.Domain.Services;
using Opah.Lib.MicrosservicoBase.Exception;
using Opah.Lib.Logger;
using Opah.Lib.HttpBase.Exception;
using Opah.Lancamento.Infra.MongoDB.Repositories;

namespace Opah.Lancamento.API
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (string.IsNullOrWhiteSpace(configuration["Opah.Lancamento-MaxMemory"]))
            {
            ...
            builder.Services.AddScoped<ILancamentoAppService, LancamentoValidator>(provider =>
                new LancamentoValidator(
                    new LancamentoAppService(provider.GetService<ILancamentoService>(),
                        provider.GetService<IOpahLogger>())));
